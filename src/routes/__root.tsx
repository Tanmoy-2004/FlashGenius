...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Paste your study notes and instantly generate flashcards and multiple-choice quizzes powered by AI." },
      { name: "author", content: "FlashGenius" },
      { property: "og:title", content: "FlashGenius — Turn notes into flashcards & quizzes" },
      { property: "og:description", content: "Paste your study notes and instantly generate flashcards and multiple-choice quizzes powered by AI." },
